...
void PlayMathGame()
{
    ...
    do
    {
        cout << "\n\nHow Many Number Of Questions Do You Want ?  ";
        cin >> NumberOQuestions;

        stQuizz Quizz;
        Quizz.NumberOfQuestions = NumberOQuestions; // Set a fixed number of questions.

        cout << "What Level do you want to play? [1] Easy, [2] Med, [3] Hard, [4] Mix ?  ";
        cin >> QuestionsLeve;
        Quizz.QuestionsLevel = (enQuestionsLevel)QuestionsLeve;

        cout << "Enter Operation Type: [1] Add, [2] Sub, [3] Mult, [4] Div, [5] Mix ?  ";
        cin >> OpTypeChoice;
        Quizz.OpType = (enOperationType)OpTypeChoice;
